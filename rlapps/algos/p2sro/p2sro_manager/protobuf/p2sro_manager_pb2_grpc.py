...
class P2SROManagerStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetDistilledMetaNash = channel.unary_unary(
            "/P2SROManager/GetDistilledMetaNash",
            request_serializer=p2sro__manager__pb2.PolicySpecJsonList.SerializeToString,
            response_deserializer=p2sro__manager__pb2.PolicySpecJson.FromString,
        )
...
def add_P2SROManagerServicer_to_server(servicer, server):
    rpc_method_handlers = {
        ...
        "GetDistilledMetaNash": grpc.unary_unary_rpc_method_handler(
            ...
            request_deserializer=p2sro__manager__pb2.PolicySpecJsonList.FromString,
            response_serializer=p2sro__manager__pb2.PolicySpecJson.SerializeToString,
        ),
    }
...
class P2SROManager(object):
    ...
    def GetDistilledMetaNash(
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            "/P2SROManager/GetDistilledMetaNash",
            p2sro__manager__pb2.PolicySpecJsonList.SerializeToString,
            p2sro__manager__pb2.PolicySpecJson.FromString,
            options,
            channel_credentials,
            insecure,
