...
from rlapps.apps.scenarios.psro_scenario import DistilledPSROScenario
...
leduc_distill_psro_dqn = DistilledPSROScenario(
    ...
    policy_classes_distill=MARWILTorchPolicy,
    get_trainer_config_distill=distill_psro_leduc_dqn_params,
    num_eval_workers=8,
